...
def banner():
 ...
 ________  ________  ________   ________  ___       ________  ________  _______   ________  ___  ___     
|\   __  \|\   __  \|\   ___  \|\   ____\|\  \     |\   __  \|\   ___ \|\  ___ \ |\   ____\|\  \|\  \    
\ \  \|\ /\ \  \|\  \ \  \\ \  \ \  \___|\ \  \    \ \  \|\  \ \  \_|\ \ \   __/|\ \  \___|\ \  \\\  \   
 \ \   __  \ \   __  \ \  \\ \  \ \  \  __\ \  \    \ \   __  \ \  \ \\ \ \  \_|/_\ \_____  \ \   __  \  
  \ \  \|\  \ \  \ \  \ \  \\ \  \ \  \|\  \ \  \____\ \  \ \  \ \  \_\\ \ \  \_|\ \|____|\  \ \  \ \  \ 
   \ \_______\ \__\ \__\ \__\\ \__\ \_______\ \_______\ \__\ \__\ \_______\ \_______\____\_\  \ \__\ \__\
    \|_______|\|__|\|__|\|__| \|__|\|_______|\|_______|\|__|\|__|\|_______|\|_______|\_________\|__|\|__|
                                                                                    \|_________|                                                                                                                                                                                                                                                                                                                        
                                

                      
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mFARDIN
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801610413971
\x1b[93;1m Facebook     \x1b[92;1m=>      \x1b[93;1m(Blank ID Bro)
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000794170374 ")
		exit()
	else:
		os.system("https://www.facebook.com/profile.php?id=100000794170374")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [BANGLADESH] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [BANGLADESH-CP] %s|%s        '%(b,idf,pw))
